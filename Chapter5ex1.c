// Программа-пример №1 из главы 5 Руководства для начинающих
// по С, 3-е издание
// Файл Chapter5ex1.c
/* Это пример программы, перечисляющий три типа школьных принадлежностей, а также стоимость их покупки
*/
#include <stdio.h>
main()
{
    ...
    printf("%c%c needs %d pencils, %d notebooks, and 1 lunchbox\n",
            firstInitial, middleInitial, number_of_pencils, number_of_notebooks);
    printf("The total cost is $%.2f", number_of_pencils*pencils
    + number_of_notebooks*notebooks + lunchbox);
    return 0;
