...
main()
{
    ...
    char Kid2[] = "Maddie";
    // Kid3 тоже содержит 7 символов, но это указано дополнительно
    char Kid3[7] = "Andrew";
    // Hero1 будет содержать 7 символов (учитывая нуль-символ!)
    char Hero1[] = "Batman";
    // Hero2 будет иметь на всякий случай дополнительное пространство
    ...
    Kid1[3] = 'i';
    Kid1[4]='e';
    Kid1[5] = '\0'; // Не забывать нуль-символ, чтобы C знал, когда
    //завершается строка
